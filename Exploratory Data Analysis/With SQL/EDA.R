...
# determine the total number of bikes available in Seoul, plus the following city information about Seoul: 
# CITY, COUNTRY, LAT, LNG, POPULATION, in a single view.
dbGetQuery(con,
